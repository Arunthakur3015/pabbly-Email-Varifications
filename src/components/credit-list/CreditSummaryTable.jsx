        ...
        <Table>
          <TableHead>
            <TableRow sx={{ backgroundColor: '#F4F6F8', height: '57.8px' }}>
              <TableCell sx={{ p: { xs: 1.5, sm: '16px' }, whiteSpace: 'nowrap' }}>
                Status/Date
              </TableCell>
              <TableCell sx={{ p: { xs: 1.5, sm: '16px' } }}>Verification Summary</TableCell>
              <TableCell sx={{ p: { xs: 1.5, sm: '16px' }, textAlign: 'right' }}>Credits</TableCell>
            </TableRow>
          </TableHead>
          ...
          <TableBody>
            {verificationLogs.map((log, idx) => (
              <TableRow key={idx} sx={{ height: '64px' }}>
                ...
                <TableCell sx={{ p: { xs: 1.5, sm: '16px' }, textAlign: 'right' }}>
