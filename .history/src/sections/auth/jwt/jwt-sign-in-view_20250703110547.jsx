  ...
  return (
    ...
    >
      <Box
        sx={{
          width: '100%',
          maxWidth: '420px', // box maximum width
          p: '32px',
      ...
      >
        ...
        <Typography
          sx={{
            ...
            mb: 2, // नीचे google button के लिए margin
            textAlign: 'center',
            maxWidth: '356px',
            width: '100%',
          }}
            ...
            <TextField
              ...
              sx={{
                ...
                '& .MuiOutlinedInput-root': {
                  height: '54px',
                  borderRadius: 1,
                  backgroundColor: 'ffffff', // force white background in the root
                  '& fieldset': { borderColor: '#e0e0e0' },
                  '&:hover fieldset': { borderColor: 'black' },
                  '&.Mui-focused fieldset': { borderColor: '#1976d2' },
                },
                '& .MuiInputBase-root': {
                  backgroundColor: 'white !important', // make sure the input container bg is white
                },
                '& .MuiInputBase-input': {
                  backgroundColor: 'white !important', // make sure actual input area bg is white
                  fontSize: '0.95rem',
                },
              }}
            />
          ...
          <Box sx={{ mb: 2 }}>
            <TextField
              ...
              sx={{
                ...
                '& .MuiInputBase-root': {
                  backgroundColor: 'white !important', // white input container bg
                },
                '& .MuiInputBase-input': {
                  backgroundColor: 'white !important', // white input text area bg
                  fontSize: '0.95rem',
                },
              }}
            />
