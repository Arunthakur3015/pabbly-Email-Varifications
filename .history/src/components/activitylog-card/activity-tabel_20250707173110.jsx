...
import <CreditsSummaryTable></CreditsSummaryTable> from 'src/components/activitylog-card/activity-tabel';
    ...
    <Box sx={{ p: 3, ml: 2, mt: 2 }}>
      ...
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body1" sx={{ color: 'text.secondary', maxWidth: 1353 }}>
          Keep track of all actions in your Pabbly Email Verification account, like verifying single
          emails, uploading and verifying email lists, downloading reports, deleting email lists,
          adding team members, and regenerating API keys. Activity Log helps you monitor changes and
          ensure everything runs smoothly. Learn more
        </Typography>
      </Box>
