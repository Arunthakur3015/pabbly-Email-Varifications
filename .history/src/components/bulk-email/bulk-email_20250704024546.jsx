    ...
    >
      <Box sx={{ width: 600, height: 512 }}>
        ...
        <DialogContent sx={{ px: 3, py: 2, overflow: 'visible' }}>
          ...
          {showFolderSelect && (
            <>
              <FormControl fullWidth sx={{ mb:0.5, position: 'relative' }}>
                ...
                >
                  ...
                  <MenuItem value="Magnet Brains">Magnet Brain</MenuItem>
                </Select>
              ...
              <Typography variant="caption" sx={{ color: 'text.secondary', mb: 2, pl:1.7 }}>
