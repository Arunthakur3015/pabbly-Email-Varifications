          ...
          {showFolderSelect && (
            <>
              <FormControl fullWidth sx={{ mb: 1.2, position: 'relative' }}>
                ...
                >
                  <MenuItem value="Home(0)">Folder 1</MenuItem>
                  <MenuItem value="Pabbly Connect">Folder 2</MenuItem>
                  <MenuItem value="Pabbly Subscription Billin...">Folder 3</MenuItem>
                  <MenuItem value="Pabbly Email Marketing">Folder 3</MenuItem>
                  <MenuItem value="Pabbly Form Builder">Folder 3</MenuItem>
                  <MenuItem value="Pabbly Hook">Folder 3</MenuItem>
                  <MenuItem value="Pabbly ">Folder 3</MenuItem>
                  <MenuItem value="Pabbly Subscription Billin...">Folder 3</MenuItem>
                  <MenuItem value="Pabbly Subscription Billin...">Folder 3</MenuItem>
