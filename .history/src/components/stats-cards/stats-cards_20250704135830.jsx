...
export function StatsCard({ sx, icon_color,icon_name, title, total, color = 'warning', ...other }) {
  ...
  return (
    <Card sx={{ py: 3, pl: 3, pr: 2.5, ...sx }} {...other}>
      ...
      <SvgColor
        src={`${CONFIG.site.basePath}/public/assets/icons/stats-card/${icon_name}.svg`}
        sx={{
          top: 24,
          right: 20,
          width: 36,
