        ...
        <DialogContent sx={{ p: 0, height: '90vh', display: 'flex', flexDirection: 'column' }}>
          ...
          >
            ...
            >
              ...
              <Typography variant="caption" color="text.secondary" display="block" mb={2}>
                Define whether the team member should have read-only or write permissions.
                Points To Remember
...
Team members do not have access to the 'Settings' section, any billing information, or the 'Trash' folder. Learn more
              </Typography>
            </Box>
