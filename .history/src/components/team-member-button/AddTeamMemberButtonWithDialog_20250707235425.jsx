        ...
        <DialogContent sx={{ p: 0, height: '90vh', display: 'flex', flexDirection: 'column' }}>
          ...
          >
            ...
            >
              ...
              />
            <Typography variant="caption" color="text.secondary" display="block" mb={2}></Typography>
              <Typography variant="caption" color="text.secondary" display="block" mb={2}>
                Define whether the team member should have read-only or write permissions. Points To
                Remember You can share multiple folders with team members. Team members can be
                granted either Write or Read access. Write access allows uploading email lists,
                starting verification, and downloading reports but restricts folder and list
                management, while Read access permits downloading reports only. Team members do not
                have access to the Setting section, any billing information, or the Trash folder.
                Learn more
              </Typography>
            </Box>
