          ...
          >
            ...
            >
              ...
              >
                ...
                <li>
                  Write access allows uploading email lists, starting verification, and downloading
                  reports but restricts folder and list management, while Read access permits
                  downloading reports only.
                </li>
                <li>
                  Team members do not have access to the Settings section, any billing information,
                  or the Trash folder.{' '}
                  <span style={{ color: '#078dee', cursor: 'pointer' }}>Learn more</span>
                </li>
              </Typography>
            </Box>
