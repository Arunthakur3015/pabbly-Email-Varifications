          ...
          {[
            ...
            <Tooltip title={item.label} arrow key={item.label}>
              <Box
                ...
                sx={{
                  ...boxSize,
                  border: selected === index ? '2px solid #61F3F3' : '1px solid transparent',
                  borderRadius: '8px',
                  backgroundColor: selected === index ? '#E0F7F7' : '#fff',
                  color: selected === index ? '#078DEE' : '#000',
                  display: 'flex',
                  flexDirection: 'column',
                  alignItems: 'center',
                  ...
                  transition: 'all 0.3s',
                  '&:hover': {
                    border: selected === index ? '2px solid #61F3F3' : '1px solid black',
                    backgroundColor: selected === index ? '#E0F7F7' : '#f4f4f4',
                  },
                }}
              >
                <Iconify
