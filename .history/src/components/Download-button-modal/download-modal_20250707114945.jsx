...
export default function DownloadModal({ open, onClose }) {
  ...
  const boxes = [
    ...
    { key: "undeliverable", label: "Undeliverable Emails", tooltip: "Download undeliverable emails" },
  ];
      ...
      >
            ...
            >
              <ButtonBase
                ...
                sx={{
                  ...
                  border: "2px solid",
                  borderColor:
                    selectedTab === item.key ? "primary.main" : "grey.300",
                  backgroundColor:
                    selectedTab === item.key ? "#61F3F3" : "white",
                  borderRadius: "8px",
                  p: 2,
                  display: "flex",
                  flexDirection: "column",
                  ...
                  "&:hover": {
                    backgroundColor:
                      selectedTab === item.key ? "#61F3F3" : "grey.100",
                    borderColor:
                      selectedTab === item.key ? "primary.main" : "black",
                    borderWidth:
                      selectedTab === item.key ? "2px" : "1px",
                  },
                }}
              >
                {item.label}
        ...
        <Box sx={{ px: 2, mt: 2 }}>
          <Typography fontSize="0.875rem" color="text.secondary">
            ...
            Simply choose a tab and click import { useState } from "react";
import {
  Box,
  Modal,
  Typography,
      ...
      >
        ...
        <Box sx={{ px: 2, mt: 2 }}>
          <Typography fontSize="0.875rem" color="text.secondary">
            ...
            The verified list and verification reports will be automatically deleted after 15
            days.{" "}
            <Link
              href="#"
              underline="always"
