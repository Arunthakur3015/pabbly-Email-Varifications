...
import circleCloseIcon from '@mui/icons-material/Close';
...
export default function DownloadModal({ open, onClose }) {
  ...
  const boxes = [
    ...
    },
    {
      ...
      icon: <circleCloseIcon fontSize="medium" />,
  ...
  return (
    <Modal open={open} onClose={onClose}>
      ...
      >
        <Box width="600" height="60" px="16px" py="8px" borderBottom= '1px solid rgb(214, 211, 211)'>
