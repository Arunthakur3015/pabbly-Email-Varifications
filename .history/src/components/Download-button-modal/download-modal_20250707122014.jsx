  ...
  return (
    <Modal open={open} onClose={onClose}>
      ...
      >
              ...
              <Box
                ...
                sx={{
                  ...
                  border: selectedBox === box.id
                    ? "2px solid #078DEE"
                    : "1px solid #e0e0e0",
                  backgroundColor: selectedBox === box.id
                    ? "#E6F7FF"
                    : "white",
                  display: "flex",
                  flexDirection: "column",
        ...
        >
          You can download email verification results by selecting one of the three tabs: All Emails,
          Deliverable Emails, or Undeliverable Emails. Simply choose a tab and click Download CSV
          to obtain the report.
          <br />
          <br />
          Note: The verified list and verification reports will be automatically deleted after 15 days.{" "}
          <a
            href="#"
            style={{
              color: "#1976d2",
