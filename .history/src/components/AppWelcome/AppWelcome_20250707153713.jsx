...
function AppWelcome({
  ...
  videoUrl,
  buttonTitle,
  containerWidth = '1086px', // 👈 container width as prop
  containerPadding = '40px', // 👈 padding as prop
  imageWidth = '435px', // 👈 image width as prop
  imageHeight = '244.68px', // 👈 image height as prop
  pointLineHeight = 1.57143, // 👈 line height as prop
  sx,
  ...other
}) {
