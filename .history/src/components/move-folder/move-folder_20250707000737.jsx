  ...
  return (
    ...
    >
      <Box sx={{ px: 3, pt: 3, pb: 2 }}>
        <Typography variant="h6" sx={{width: 600, height: 76, fontSize: 20, fontWeight: 600 }}>
          {title}
        </Typography>

        <Divider sx={{ mt: 2, mb: 0 }} />

        <DialogContent sx={{ width: 600, height: 88.72,px: 0, py: 0, overflow: 'visible', mt: 2.5 }}>
