...
export default function MoveFolderModal({ open, onClose, title = 'Move to Folder' }) {
  ...
  return (
    ...
    >
      <Box sx={{ width: 600, height: 248.72, px: 3, pt: 3, pb: 2 }}>
        ...
        <DialogContent sx={{ px: 0, py: 0, overflow: 'visible', mt: 2 }}>
          ...
          <Typography variant="body2" sx={{ pl: 2, mt: 1, color: 'text.secondary', fontSize: 13 }}>
