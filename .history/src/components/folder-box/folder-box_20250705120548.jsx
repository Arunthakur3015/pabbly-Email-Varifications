...
import { useSnackbar } from 'src/components/snackbar/CustomSnackbar'; // ✅ Add this
...
export default function FolderListBox() {
  ...
  const handleDeleteConfirm = () => {
    ...
    handleMenuClose();
    showSnackbar('Folder deleted successfully!'); // ✅ Snackbar shown
  };
  ...
  return (
    ...
    >
      ...
      <FolderOptionsMenu
        ...
        onShare={() => console.log(`Share: ${selectedFolder?.name}`)}
