  ...
  return (
    ...
    >
        ...
        <Box display="flex" flexDirection="column" gap="2px" >
          {folders.map((name, index) => (
            <Tooltip title="Number of lists in this folder" placement="top" arrow key={name}>
              ...
              >
                <Typography fontSize='14px' fontWeight='800px' noWrap>
                  {name}{'  '}
                  <Typography fontSize='14px' color='grey' ml=''component="span">
                    (0)
                  </Typography>
                </Typography>
      ...
      <Box>
        ...
        >
          <Typography fontSize='14px' fontWeight='800px' pt='12px'>Trash (0)</Typography>
        </Box>
      </Box>
    </Box>
  );
