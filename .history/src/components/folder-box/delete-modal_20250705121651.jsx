...
import { useSnackbar } from 'src/components/snackbar/CustomSnackbar'; // ✅ import
...
export default function CustomModal({
  ...
  const { showSnackbar } = useSnackbar(); // ✅ hook use

  const handleDelete = () => {
    onConfirm();
    onClose();
    showSnackbar(`${confirmText} successfully!`); // ✅ snackbar call
  };
