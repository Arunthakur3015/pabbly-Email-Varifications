    ...
    >
      ...
      {folders.map((name, index) => (
        <Tooltip key={name} title="Number of lists in this folder" placement="top" arrow>
          ...
          >
            ...
            >
              {name} <Typography component="span" sx={{ color: 'text.secondary', fontSize: 13 }}> (0)</Typography>
            </Typography>
      ...
      >
        <Typography fontSize={14}>
          Trash <Typography component="span" sx={{ color: 'text.secondary', fontSize: 13 }}>(0)</Typography>
        </Typography>
      </Box>
    </Box>
  );
