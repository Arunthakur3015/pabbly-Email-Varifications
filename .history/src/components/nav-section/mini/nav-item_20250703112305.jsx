...
const StyledNavItem = styled(ButtonBase, {
  ...
  const baseStyles = {
    item: {
      ...
      '&:hover': {
        ...
        [`& .${navSectionClasses.item.title}`]: {
          color: '#078DEE', // 👈 hover pe title ka color icon ke saath match kare
        },
      },
    },
    ...
    info: { ...sharedStyles.info }, // ✅ corrected: sharedStyles se hi info ka style
  };
  ...
  return {
    ...
    ...(rootItem && {
      ...
      [`& .${navSectionClasses.item.title}`]: {
        ...
        color: '#FFFFFF', // 👈 default title color white
      },
