...
const StyledNavItem = styled(ButtonBase, {
  ...
  const baseStyles = {
    item: {
      ...
      color: 'white', // ✅ All icons white by default
      '&:hover': {
        color: '#078DEE',
    ...
    icon: {
      ...
      color: title === 'Dashboard' ? '#078DEE' : 'white', // ✅ Dashboard blue, others white
    },
  ...
  return {
    ...(rootItem && {
      ...
      [`& .${navSectionClasses.item.icon}`]: {
        ...
        color: active || open ? '#078DEE' : title === 'Dashboard' ? '#078DEE' : 'white', // ✅ Active OR dashboard = blue, rest white
      },
      [`& .${navSectionClasses.item.title}`]: {
        ...baseStyles.title,
        ...sharedStyles.noWrap,
        ...
        color: active || open ? '#078DEE' : title === 'Dashboard' ? '#078DEE' : 'white', // ✅ Same logic for title
      },
