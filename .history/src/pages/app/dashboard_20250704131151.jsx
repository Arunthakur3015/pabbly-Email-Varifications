...
export default function Dashboard() {
  ...
  return (
    <Box sx={{ pt: 1.5, px: 5 }}>
      ...
      <StatsCard total='32' title='Email Credits Consumed'/>
      <StatsCard total='9968' title='Email Credits Remaining'/>
      <StatsCard total='100' title='Total Number of Email Lists'/> 
    </Box>
  );
}
