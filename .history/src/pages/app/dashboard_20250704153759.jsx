...
export default function Dashboard() {
  ...
  return (
    <Box sx={{ pt: 1.5, px: 5 }}>
      ...
      >
        <StatsCard title="Email Credits Consumed" total={32} icon_name="consumed.svg" bg_gradient="#FFA92E" />
        <StatsCard title="Email Credits Remaining" total={9968} icon_name="Renaming.svg" bg_gradient="#10CBF3" />
        <StatsCard title="Total Number of Email Lists" total={100} icon_name="email.svg" bg_gradient="#28A745" />
      </Box>
    </Box>
  );
}
