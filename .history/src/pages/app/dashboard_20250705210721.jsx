...
import EmailListUI from 'src/components/list-box/list-box';
...
import VerifySingleEmailModal from 'src/components/verifysingleemail/verify-single'; // ✅ Import your email list component
...
export default function Dashboard() {
  ...
  return (
    <Box sx={{ pt: 1, px: 5 }}>
      ...
      {/* ✅ Email List Section below Folder Box */}
      <Box sx={{ mt: 3 }}>
        <EmailListUI />
      </Box>
    </Box>
