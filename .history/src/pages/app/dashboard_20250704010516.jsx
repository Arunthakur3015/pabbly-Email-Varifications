...
import BulkVerifyModal from 'src/components/bulkverify/bulk-modal'; // ✅ Yeh import hona chahiye, not bulk-email
...
export default function Dashboard() {
  ...
  return (
    <Box sx={{ pt: 1.5, px: 5 }}>
      ...
      <BulkVerifyModal open={openBulkEmailModal} onClose={handleCloseBulkModal} /> 
    </Box>
  );
}
