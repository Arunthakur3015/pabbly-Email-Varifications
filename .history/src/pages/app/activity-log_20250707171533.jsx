    ...
    <Container maxWidth="xl" sx={{ mt: 5 }}>
      ...
      <ApiCard
              points={[
                ...
                'Each verification through the API consumes 1 email credit from your accounts allotted email credits.',
                ...
                'Refer to the detailed API documentation for endpoint URLs, parameters and examples. Learn more',
              ]}
