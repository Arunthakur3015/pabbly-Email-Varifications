...
export function UserTableRow({
  ...
  onSelectRow,
  onDeleteRow,
  onMoveToFolder, // ✅ called when "Move to folder" is clicked
  userTableIndex,
  emailCredit,
  emailGreen,
  buttonRowabc,
  ...
  return (
    <>
      <TableRow hover selected={selected} aria-checked={selected} tabIndex={-1}>
        ...
        <TableCell align="right" sx={{ width: 267, minWidth: 267, maxWidth: 267, pr: 1 }}>
          <Button variant="outlined" color="primary">
            {buttonrow[buttonRowabc % buttonrow.length]}
          </Button>
        </TableCell>

        <TableCell sx={{ width: 52, minWidth: 52, maxWidth: 52 }}>
      ...
      >
        <MenuItem
          onClick={() => {
            popover.onClose();
            onMoveToFolder(); // ✅ triggers MoveFolderModal from parent
          }}
        >
