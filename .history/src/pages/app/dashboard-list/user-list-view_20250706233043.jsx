// ✅ FINAL UPDATED CODE for UserListView.jsx
...
import { toast } from 'src/components/snackbar copy';
import { Scrollbar } from 'src/components/scrollbar';
import { ConfirmDialog } from 'src/components/custom-dialog';
import MoveFolderModal from '<source />
<components></components>/move-folder/move-folder';
...
const TABLE_HEAD = [
  {
    ...
    width: 357.06,
    sx: { width: 357.06, minWidth: 357.06, maxWidth: 357.06 },
  },
  {
    id: 'email/credit',
    label: 'Number of Emails/Credits Consumed',
    width: 362.08,
    sx: { width: 362.08, minWidth: 362.08, maxWidth: 362.08 },
  },
  {
    id: 'action',
    label: 'Action',
    align: 'right',
    width: 267,
    sx: { width: 267, minWidth: 267, maxWidth: 267, textAlign: 'right' },
  },
  { id: '', width: 52, sx: { width: 52, minWidth: 52, maxWidth: 52 } },
];
...
export function UserListView() {
  ...
  return (
    <>
      <Box sx={{ width: '1086px', mx: 'auto', ml: 3, mt: 3.5 }}>
        <Card sx={{ mt: 4 }}>
          <CardHeader variant="H6" title={<Typography>Home</Typography>} sx={{ mb: 1.5, fontSize: 18 }} />
          ...
          <UserTableToolbar filters={filters} onResetPage={table.onResetPage} options={{ roles: _roles }} sx={{ width: 966 }} />
          ...
          <Box sx={{ position: 'relative' }}>
            ...
            <Scrollbar>
              <Table size={table.dense ? 'small' : 'medium'} sx={{ minWidth: 960 }}>
                ...
                <TableBody>
                  {dataFiltered.slice(table.page * table.rowsPerPage, table.page * table.rowsPerPage + table.rowsPerPage).map((row, index) => (
                    <UserTableRow
                      key={row.id}
                      row={row}
                      ...
                      onMoveToFolder={handleOpenMoveFolderModal} // ✅ new prop
                    />
                  ))}
