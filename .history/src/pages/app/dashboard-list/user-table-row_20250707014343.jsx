...
// Drawer content components for different drawer types
...
export function UserTableRow({
  ...
  // Open drawer with type to render specific content
  ...
  // Decide what to do on button click based on label
  const handleButtonClick = (label) => {
    ...
    // 'Start Verification' modal handling later
  };

  // Render drawer content based on drawerType
