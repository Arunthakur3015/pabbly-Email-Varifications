...
export function UserTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow, userTableIndex, emailCredit, emailGreen }) {
        ...
        <TableCell>
          <Stack spacing={2} direction="row" alignItems="center">
            <Stack sx={{ typography: 'body2', flex: '1 1 auto', alignItems: 'flex-start' }}>
              ...
              <Box component="span" sx={{ color: 'text.disabled', fontcolor }}>
