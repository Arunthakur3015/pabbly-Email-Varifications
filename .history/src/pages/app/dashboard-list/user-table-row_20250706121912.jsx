...
export function UserTableRow({ row, selected, onEditRow, onSelectRow, onDeleteRow, userTableIndex, emailCredit }) {
        ...
        <TableCell>
          <Stack spacing={2} direction="row" alignItems="center">
            <Stack sx={{ typography: 'body2', flex: '1 1 auto', alignItems: 'flex-start' }}>
              <Box color="inherit" onClick={onEditRow} sx={{ cursor: 'pointer', fontSize: '' }}>
