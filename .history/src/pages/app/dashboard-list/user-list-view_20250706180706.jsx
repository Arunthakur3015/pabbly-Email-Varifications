...
const TABLE_HEAD = [
  { id: 'status/name/date', label: 'Status/Name/Date', width: 357.06 },
  { id: 'email/credit', label: 'Number of Emails/Credits Consumed', width: 362.08 },
  { id: 'status', label: 'Status', width: '267px' },
  { id: '', width: 88 },
];
...
export function UserListView() {
  ...
  return (
    <>
      <Card sx={{ mt: 4 }}>
        <CardHeader variant='H6' title={<Typography>Home</Typography>} description={<Typography>Verify and manage all your uploaded email lists here.</Typography>} />
        <Divider />
