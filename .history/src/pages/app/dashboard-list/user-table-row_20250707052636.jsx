  ...
  return (
    <>
      ...
      >
        ...
        <Box component="span" className="material-icons" sx={{ color: '#FFAB00', fontSize: 28 }} />
        ...
        >
          <MdWarning size={50} color="#FFAB00" sx={{alignItems: 'flex-start'}}/>
          <Box sx={{ fontSize: '14px', lineHeight: 1.5,color:'#8A5719' }}>
