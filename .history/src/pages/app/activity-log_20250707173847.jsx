...
import Activity from 'src/components/activitylog-card/Activity';
import CreditsSummaryTable from 'src/components/credit-list/CreditSummaryTable';

const metadata = { title: `DashboardPabbly Chatflow | Pabbly Chatflow` };
    ...
    <Container maxWidth="xl" sx={{ mt: 5 }}>
      <Box>
        <Box sx={{ mb: 3 }}>
          ...
          <Typography variant="body1" sx={{ color: 'text.secondary', maxWidth: 1353 }}>
            Keep track of all actions in your Pabbly Email Verification account, like verifying
            single emails, uploading and verifying email lists, downloading reports, deleting email
            lists, adding team members, and regenerating API keys. Activity Log helps you monitor
            changes and ensure everything runs smoothly.{' '}
            <Box
              component="span"
              sx={{
                color: 'primary.main',
      ...
      <Box>
        <Activity
          ...
          img="../assets/images/activity-log.png"
