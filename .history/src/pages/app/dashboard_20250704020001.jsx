...
import VerifySingleEmailModal from 'src/components/verifysingleemail/verify-single'; // ✅ for single
import BulkVerifyEmailModal from 'src/components/bulkverify/bulk-email'; // ✅ for bulk
