...
import ApiCard from 'src/components/API-card/API-card';
import ApiKeyBox from 'src/components/API section/apikeysection';
    ...
    <Container maxWidth="xl" sx={{ mt: 5, mb: 3 }}>
      <Box sx={{ mb: 3 }}>
        ...
        <Typography variant="body1" sx={{ color: 'text.secondary', maxWidth: 1353 }}>
          Generate your API Key and Secret Key to perform email verifications directly through the
