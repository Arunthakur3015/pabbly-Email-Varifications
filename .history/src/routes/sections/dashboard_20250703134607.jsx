...
import { CONFIG } from 'src/config-global';time
...
const Activity = lazy(() => import('src/pages/app/activity-log'));
const TimeZone = lazy(() => import('src/pages/app/-zone'));
    ...
    children: [
      ...
      { path: 'get-help', element: <Gethelp /> },
      {
        ...
        children: [
          ...
          { path: 'team-members', element: <TimeZone /> },
        ],
      },
    ],
  },
